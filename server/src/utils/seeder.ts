...
export async function seedDemoData(prisma: PrismaClient) {
  ...
  const tradeTemplates = [
    { num: 1, side: 'SHORT' as const, mult: -1.0, dur: 3.5, entrySig: 'Sell Breakout', exitSig: 'Stop Loss', mfe: 0.15, mae: 1.0, tag: 'Breakout' },
    { num: 2, side: 'LONG' as const, mult: 2.5, dur: 12.0, entrySig: 'Buy Support', exitSig: 'Take Profit', mfe: 2.7, mae: 0.25, tag: 'Pullback' },
    { num: 3, side: 'LONG' as const, mult: 1.2, dur: 8.5, entrySig: 'Buy Support', exitSig: 'Manual Exit', mfe: 1.8, mae: 0.35, tag: 'Pullback' },
    { num: 4, side: 'SHORT' as const, mult: -1.0, dur: 2.0, entrySig: 'Sell Breakout', exitSig: 'Stop Loss', mfe: 0.05, mae: 1.05, tag: 'Breakout' },
    { num: 5, side: 'SHORT' as const, mult: 0.0, dur: 4.0, entrySig: 'Sell Breakout', exitSig: 'Trailing Stop', mfe: 0.5, mae: 0.45, tag: 'Breakout' },
    { num: 6, side: 'LONG' as const, mult: 3.5, dur: 24.5, entrySig: 'Buy Breakout', exitSig: 'Take Profit', mfe: 3.6, mae: 0.15, tag: 'Breakout' },
    { num: 7, side: 'LONG' as const, mult: -1.0, dur: 1.5, entrySig: 'Buy Support', exitSig: 'Stop Loss', mfe: 0.1, mae: 1.0, tag: 'Pullback' },
    { num: 8, side: 'SHORT' as const, mult: 2.1, dur: 15.0, entrySig: 'Sell Resistance', exitSig: 'Trailing Stop', mfe: 2.3, mae: 0.3, tag: 'Mean Reversion' },
    { num: 9, side: 'SHORT' as const, mult: -0.5, dur: 5.5, entrySig: 'Sell Resistance', exitSig: 'Trailing Stop', mfe: 0.8, mae: 0.9, tag: 'Mean Reversion' },
    { num: 10, side: 'LONG' as const, mult: 4.2, dur: 36.0, entrySig: 'Buy Breakout', exitSig: 'Take Profit', mfe: 4.5, mae: 0.2, tag: 'Breakout' },
    { num: 11, side: 'LONG' as const, mult: -1.0, dur: 3.0, entrySig: 'Buy Support', exitSig: 'Stop Loss', mfe: 0.2, mae: 1.0, tag: 'Pullback' },
    { num: 12, side: 'SHORT' as const, mult: -1.0, dur: 2.5, entrySig: 'Sell Breakout', exitSig: 'Stop Loss', mfe: 0.1, mae: 1.0, tag: 'Breakout' },
    { num: 13, side: 'LONG' as const, mult: 1.8, dur: 10.0, entrySig: 'Buy Breakout', exitSig: 'Trailing Stop', mfe: 2.2, mae: 0.4, tag: 'Breakout' },
    { num: 14, side: 'SHORT' as const, mult: 0.0, dur: 6.0, entrySig: 'Sell Resistance', exitSig: 'Trailing Stop', mfe: 0.4, mae: 0.5, tag: 'Mean Reversion' },
    { num: 15, side: 'LONG' as const, mult: 3.0, dur: 18.0, entrySig: 'Buy Support', exitSig: 'Take Profit', mfe: 3.1, mae: 0.1, tag: 'Pullback' },
  ];
